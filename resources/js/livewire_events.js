document.addEventListener('DOMContentLoaded', function(){
    ...
    Livewire.on('warning', function(text, title = '¡Alerta!'){
      Swal.fire({
          title: title,
          text: text,
          icon: 'warning',
    ...
    Livewire.on('info', function(text, title = 'Info'){
      Swal.fire({
          title: title,
          text: text,
          icon: 'info',
        ...
        if (result.isConfirmed) {
          if(result.value.success){
            ...
            Swal.fire({
              ...
              html: `<a target="_blank" href="facturacion/ver_pdf/${result.value.id}">Ver PDF de Pago</a>`,
              icon: 'success',
