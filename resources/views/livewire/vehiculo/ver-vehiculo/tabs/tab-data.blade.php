    ...
    <div style="overflow: scroll;" class="card-body">
        <div class="row">
            <div class="col-3">
                ...
                <div class="p-3">
                    <a class="btn btn-success btn-md" target="_blank" href="https://web.whatsapp.com/send?text=¡Mira%20esto!%20{{ url()->current() }}"><i class="fab fa-whatsapp"></i> Enviar Whatsapp</a>
