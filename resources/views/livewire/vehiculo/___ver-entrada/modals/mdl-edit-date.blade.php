<div wire:ignore.self class="modal fade" data-backdrop="static" id="mdlEditDate">
    <div class="modal-dialog modal-dialog-scrollable modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{$this->fecha_titulo}}</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-12">
                        ...
                        <label>{{$this->fecha_titulo}}</label>
                        <input wire:model.defer="fecha" type="datetime-local" class="form-control" />
                    </div>
                </div>
            </div>
