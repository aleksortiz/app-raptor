                ...
                <form>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-3">
                            ...
                            <input disabled wire:model.defer="model.existencia"  type="text" class="form-control" style="text-align: center" onkeypress="return event.charCode >= 46 && event.charCode <= 57"/>
