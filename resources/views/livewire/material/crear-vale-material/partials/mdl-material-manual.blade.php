        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-4">
                        <label>Entrada</label>
                        <input wire:keydown.enter="validateEntrada" style="text-align: center;" onkeypress="return event.charCode >= 45 && event.charCode <= 57" wire:model.defer="materialManual.entrada_folio" type="text" class="form-control" />
                        @error('materialManual.entrada_folio')
                            <span class="error text-danger">Entrada no válida</span>
                        @enderror
                    </div>
                </div>
                ...
                @if ($this->selectedEntrada)                    
                    <div class="row">
                        <div class="col">
                            <span class="text-success">{{$this->selectedEntrada->folio_short}} {{$this->selectedEntrada->vehiculo}}</span>
                        </div>
                    </div>
                @endif
            ...
            <div class="modal-footer justify-content-between">
                ...
                @else
                    <button type="button" wire:click.prevent="" disabled class="btn btn-danger"><i
                        class="fas fa-times"></i> Validar Entrada</button>
                @endif
