                ...
                <div class="card-body text-center">
                    @if($constanciaUrl)
                        <div class="mb-3">
                            ...
                            <a href="{{ route('documento.download', ['url' => $constanciaUrl, 'filename' => 'constancia_fiscal_' . ($requisicion->cliente?->nombre ?? 'cliente')]) }}" class="btn btn-secondary ml-2">
                ...
                <div class="card-body text-center">
                    @if($ineUrl)
                        <div class="mb-3">
                            ...
                            <a href="{{ route('documento.download', ['url' => $ineUrl, 'filename' => 'ine_' . ($entrada->cliente?->nombre ?? $entrada->folio)]) }}" class="btn btn-secondary ml-2">
                                <i class="fas fa-download mr-1"></i> Descargar
                            </a>
                        </div>
                        <div class="embed-responsive embed-responsive-16by9">
                ...
                <div class="card-body text-center">
                    @if($ordenAdmisionUrl)
                        <div class="mb-3">
                            ...
                            <a href="{{ route('documento.download', ['url' => $ordenAdmisionUrl, 'filename' => 'orden_admision_' . $entrada->folio]) }}" class="btn btn-secondary ml-2">
                                <i class="fas fa-download mr-1"></i> Descargar
                            </a>
                        </div>
                        <div class="embed-responsive embed-responsive-16by9">
