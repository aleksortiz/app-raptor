    ...
    <div class="row" style="margin-left: 5%; margin-right: 5%;">
        ...
        @else
          <div class="col-sm-12 p-5">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" wire:model.defer="kilometraje" class="form-control form-control-lg" placeholder="Kilometraje" onkeypress="return event.charCode >= 46 && event.charCode <= 57">
            ...
            <div class="row">
              ...
              <div class="col-3">
                  <div class="form-group">
                      ...
                      <input type="text" wire:model.defer="color" class="form-control form-control-lg" placeholder="Color" onkeypress="return event.charCode >= 46 && event.charCode <= 57">
                ...
                <div class="col-3">
                    <div class="form-group">
                        ...
                        <input type="text" wire:model.defer="placas" class="form-control form-control-lg" placeholder="Placas" onkeypress="return event.charCode >= 46 && event.charCode <= 57">
            ...
            <div class="mt-5 row">
              <div class="col">
                <button class="btn btn-block btn-success btn-lg" wire:click="toggle">TERMINAR <i class="fa fa-check"></i></button>
