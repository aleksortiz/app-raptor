<div wire:ignore.self class="modal fade" data-backdrop="static" id="mdl-crear-asignacion">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Nueva Asignación de Trabajo</h5>
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" class="btn btn-primary" wire:click="guardar"><i class="fas fa-save"></i> Guardar</button>
            </div>
        </div>
    </div>
</div>
