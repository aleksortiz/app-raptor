                    ...
                    <tbody>
                        ...
                        @if ($this->costo && $this->costo->id == 0)
                            <tr>
                                ...
                                <td>N/A</td>
                                <td><button wire:click="removeCosto" class="btn btn-danger btn-xs"><i class="fa fa-times"></i> Cancelar</button></td>
                            </tr>
                        @endif
                        ...
                        @foreach ($entrada->costos as $item)
                            ...
                            <tr>
                                <td>
                                  ...
                                  @else
                                    <button wire:click="" onclick="destroy({{ $item->id }},'Costo', 'destroyCosto')" class="btn btn-xs btn-danger"><i class="fa fa-trash-alt"></i></button></td>    
                                  @endif
                                ...
                                <td>
                                  @if($item->pagado)
                                    @if ($editMode)
                                      <button wire:click="eliminarPagoServicio({{ $item->id }})" class="btn btn-xs btn-danger"><i class="fa fa-times"></i> Eliminar Pago</button>
                                    @else  
                                      <i style="color: green;" class="fa fa-check"></i> Pagado: {{ $item->fecha_pago_format }}
                                    @endif
                                  @else
                                    @if ($editMode)
                                      N/A
                                    @else  
                                      <button wire:click="pagarServicio({{ $item->id }})" class="btn btn-xs btn-secondary"><i class="fa fa-clock"></i> Pago Pendiente</button> 
                                    @endif
                                ...
                                <td>
                                  @if ($editMode)
                                    <button wire:click="removeCosto" class="btn btn-danger btn-xs"><i class="fa fa-times"></i> Cancelar</button>
                                  @else  
                                    <button wire:click="editCosto({{ $item->id }})" class="btn btn-xs btn-warning"><i class="fa fa-edit"></i> Editar</button>
                                  @endif
                                </td>
                            </tr>
                        @endforeach
